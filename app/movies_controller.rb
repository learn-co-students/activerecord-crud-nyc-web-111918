...
def can_find_using_where_clause_and_be_sorted
  ...
  # sql = <<-SQL
  #   SELECT * FROM movies
  #   WHERE m.release_date > 2002
  #   ORDER BY m.release_date DESC
  # SQL

  Movie.where("release_date > 2002").order("release_date desc") #"release_date: > 2002")
...
def can_be_found_updated_and_saved
  ...
  my_movie = Movie.all.find_by(title: "Awesome Flick")
  my_movie.update(title: "Even Awesomer Flick")
  my_movie.save
end
